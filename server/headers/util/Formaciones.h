...
std::vector<Coordinates> getFormation(int local, int form){


  Coordinates arquero (local*(LEVEL_WIDTH-120*2) + 120- SPRITE_SIZE/2, 500 - SPRITE_SIZE/2);
  Coordinates defensa1 (local*(LEVEL_WIDTH-400*2) + 400- SPRITE_SIZE/2, 500 - SPRITE_SIZE/2);
  Coordinates defensa2 (local*(LEVEL_WIDTH-400*2) + 400- SPRITE_SIZE/2, 250 - SPRITE_SIZE/2);
  Coordinates defensa3 (local*(LEVEL_WIDTH-400*2) + 400- SPRITE_SIZE/2, 750 - SPRITE_SIZE/2);
  Coordinates medio1 (local*(LEVEL_WIDTH-750*2) + 750- SPRITE_SIZE/2, 400 - SPRITE_SIZE/2);
  Coordinates medio2 (local*(LEVEL_WIDTH-750*2) + 750- SPRITE_SIZE/2, 500 - SPRITE_SIZE/2);
  Coordinates medio3 (local*(LEVEL_WIDTH-750*2) + 750- SPRITE_SIZE/2, 600 - SPRITE_SIZE/2);
  Coordinates delantero1 (local*(LEVEL_WIDTH-1200*2) + 1200- SPRITE_SIZE/2, 350 - SPRITE_SIZE/2);
  Coordinates delantero2 (local*(LEVEL_WIDTH-1200*2) + 1200- SPRITE_SIZE/2, 500 - SPRITE_SIZE/2);
  Coordinates delantero3 (local*(LEVEL_WIDTH-1200*2) + 1200- SPRITE_SIZE/2, 750 - SPRITE_SIZE/2);
