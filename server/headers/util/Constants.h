...
enum PlayerOrientations {
    ...
    PLAYER_ORIENTATION_UP_R = 2,
    PLAYER_ORIENTATION_RIGHT = 3,
    PLAYER_ORIENTATION_DOWN_R = 4,
    PLAYER_ORIENTATION_DOWN = 5,
    PLAYER_ORIENTATION_DOWN_L= 6,
    PLAYER_ORIENTATION_LEFT = 7,
    PLAYER_ORIENTATION_UP_L = 8,
    PLAYER_ORIENTATION_INVALID = 9
};
