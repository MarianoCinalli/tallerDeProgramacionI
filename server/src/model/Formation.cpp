...
Coordinates* Formation::getCoordinatesForPlayer312(int playerNumber) {
    ...
    switch(playerNumber) {
        ...
        case 4:
            ...
            break;
        case 5:
            coordinates = new Coordinates(777, 501);
            break;
        case 6:
...
Coordinates* Formation::getCoordinatesForPlayerOnTheRightside321(int playerNumber) {
    ...
    switch(playerNumber) {
        case 1:
            ...
            break;
        case 2:
            coordinates = new Coordinates(1288, 501);
            break;
        case 3:
        ...
        case 4:
            ...
            break;
        case 5:
            coordinates = new Coordinates(940, 501);
            break;
        case 6:
            coordinates = new Coordinates(360, 323);
            break;
        case 7:
            coordinates = new Coordinates(360, 674);
            break;
        default:
            log("Formation: Numero de jugador no entendido: ", playerNumber, LOG_ERROR);
    }
...
Coordinates* Formation::getCoordinatesForPlayerOnTheRightside33(int playerNumber) {
    ...
    switch(playerNumber) {
        ...
        case 4:
            ...
            break;
        case 5:
            coordinates = new Coordinates(400, 501);
            break;
        case 6:
            coordinates = new Coordinates(410, 100);
            break;
...
Coordinates* Formation::getCoordinatesForPlayerOnTheRightside312(int playerNumber) {
    ...
    switch(playerNumber) {
        ...
        case 6:
            ...
            break;
        case 7:
            coordinates = new Coordinates(350, 501);
            break;
        default:
            log("Formation: Numero de jugador no entendido: ", playerNumber, LOG_ERROR);
    }
